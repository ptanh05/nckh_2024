...
import { Shield, FileText, UserCheck, RotateCcw, Lock, Key } from "lucide-react"
  ...
  return (
    <main>
        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold gradient-text">Secure Your Digital Legacy</h1>
              <p className="text-lg text-[#a7a9be] max-w-xl">
                Blockchain Heritage Management System helps you preserve and transfer your digital assets securely using
      ...
      <section className="py-16 md:py-24 bg-[#1f1e27]" id="features">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold gradient-text mb-4">Core Features</h2>
      ...
      <section className="py-16 md:py-24" id="nft">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold gradient-text mb-4">NFT Management</h2>
            <p className="text-[#a7a9be] max-w-2xl mx-auto">Advanced tools for your digital collectibles</p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-[#1f1e27]" id="how-it-works">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-[#a7a9be] max-w-2xl mx-auto">Simple steps to secure your digital legacy</p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            {[
              ...
              },
              {
                ...
                description: "Keep track of your assets, make updates, or request refunds if circumstances change.",
              },
            ].map((step, index) => (
      ...
      <section className="py-16 md:py-24" id="dashboard">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold gradient-text mb-4">Dashboard Preview</h2>
            <p className="text-[#a7a9be] max-w-2xl mx-auto">
      ...
      <section className="py-16 md:py-24 gradient-bg">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Secure Your Digital Legacy?</h2>
          <p className="text-white/80 max-w-2xl mx-auto mb-8">
            Join thousands of users who trust BHMS to protect and manage their digital assets for future generations.
          </p>
